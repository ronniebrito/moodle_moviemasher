<?php echo '<?xml version="1.0" encoding="utf-8"?>'; ?>
	...
	<control id="uploader" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@CGI"
		tooltip="Envie um arquivo de video ou imagem" upload="media/php/upload.php?id=<?php echo $mash_id; ?>&amp;userid=<?php echo $userid; ?>&amp;cmid=<?php echo $cmid; ?>"  		
		icon="../../moviemasher/com/moviemasher/skin/Liquid/stable.swf@BtnOff"
		overicon="../../moviemasher/com/moviemasher/skin/Liquid/stable.swf@BtnOn"
		disicon="../../moviemasher/com/moviemasher/skin/Liquid/stable.swf@BtnDis"
		fill='stretch' pattern='Importar mídia' 
		width='100' textalign='center' textsize="11" textcolor='333333'
	>		
		<filetype description="Arquivos de vídeo" extension="*.flv;*.mpeg;*.mpeg4;*.avi;*.mpg;*.mp4;*.jpg;*.png" />
	</control>
  </bar>
  <bar size="24" spacing="2" padding="1">
...
<!-- Glossario -->
	<control 	
		...
		get='javascript:window.window.open("http://www.signbank.org/signpuddle2.0/signmaker.php?ui=1&sgn=46","glossario");'
		icon="../../moviemasher/com/moviemasher/skin/Liquid/stable.swf@BtnOff"
		overicon="../../moviemasher/com/moviemasher/skin/Liquid/stable.swf@BtnOn"
		disicon="../../moviemasher/com/moviemasher/skin/Liquid/stable.swf@BtnDis"
