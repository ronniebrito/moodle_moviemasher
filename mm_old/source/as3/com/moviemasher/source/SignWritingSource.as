...
*/
	public class SignWritingSource extends RemoteSource
	{
		...
		{ 
			...
			_indexKey = 'page';
			_sortKey = 'orderby';
			//var	swhost = RunClass.MovieMasher['getByID']('swhost') as String;
			//_defaults.url = 'http://www.nals.cce.ufsc.br/glossario/bsw.php?';
			_defaults.url = 'media/php/querySignPuddle.php?';
			_defaults.api_key = '';			
		}
		...
		private function __tagFromTag(bsw:String):XML
		{
			...
			//{
				...
				var url = RunClass.MD5['hash'](bsw);
				tag.@id = bsw;
				tag.@bsw = bsw;
				tag.@type = 'image';
				//tag.@url = 'http://localhost/moodle/mod/moviemasher/temp/'+ bsw.slice(0,128)+'.png';
				tag.@url = '../../../temp/'+ url.slice(0,128)+'.png';
				tag.@href = '../../../temp/'+ url.slice(0,128)+'.png';
				tag.@icon = '../../../temp/'+url.slice(0,128)+'.png';
