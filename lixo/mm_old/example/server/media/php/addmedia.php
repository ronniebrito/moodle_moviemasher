...
if (! $err)
{
	...
	if (! ($dir_host && $path_site && $filename && $path_media && ($host_media || $moviemasher_file->uploadsLocally())))
	{
		$err = 'Configuration options DirHost, PathSite, PathMedia, CoderFilename and perhaps HostMedia required';
	}
}
