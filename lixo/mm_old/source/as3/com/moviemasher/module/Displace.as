	...
	public class Displace extends Composite
	{
		...
		{ 
			...
			if ((__composited != null) && (__module != null))
			{
				...
				var backcolor:String = __module.getValue(ModuleProperty.BACKCOLOR).string;
				...
				*/
				new_filters.push(new DisplacementMapFilter(__bitmapData, null, channel_int, channel_int, scale[0], scale[1]));
			}
