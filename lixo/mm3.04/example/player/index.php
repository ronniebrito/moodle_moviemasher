...
swfobject.embedSWF("../../moviemasher/com/moviemasher/core/MovieMasher/stable.swf", "moviemasher_player_layer", "100%", "100%", "10.0.0", "../media/js/swfobject/expressInstall.swf", flashvarsObj, parObj, parObj);
...
<body>    
	...
	<div id="moviemasher_player_layer">
