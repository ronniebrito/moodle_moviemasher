...
*/
	public class SignWritingSource extends RemoteSource
	{
		...
		{ 
			...
			_defaults.url = 'http://rocha.ava.ufsc.br:8081/~ronnie/etica/moodle/mod/moviemasher/binarySignWriting.php?';
			_defaults.api_key = '';			
		}
		...
		private function __tagFromTag(bsw:String):XML
		{
			...
			//{
				...
				tag.@type = 'image';
				tag.@url = 'http://rocha.ava.ufsc.br:8081/~ronnie/etica/moodle/mod/moviemasher/temp/'+bsw+'.png';
				tag.@icon = 'http://rocha.ava.ufsc.br:8081/~ronnie/etica/moodle/mod/moviemasher/temp/'+bsw+'.png';
				trace( 'url'+'http://rocha.ava.ufsc.br:8081/~ronnie/etica/moodle/mod/moviemasher/binarySignWritingImage.php?bsw='+bsw);
