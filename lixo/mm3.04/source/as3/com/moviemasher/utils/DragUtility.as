...
/**
* Registers the Sprite that will contain the drag previews
*
* @param target Sprite object that will have hold previews
*/
		public static function registerClipParent(target:Sprite):void 
		{
			__clipParent=target;
		}
/**
...
*/
		...
		private static function __move():void 
		{
			try 
			{
				//if ((__clipParent.stage != null) && (event != null) && (! (event.stageX == __clipParent.stage.mouseX) && (event.stageY == __clipParent.stage.mouseY))) return;
				...
				if (! __dragging) 
				{
					...
					__dragging = true;
					__clipParent.addChild(__dragData.display);
				}
		...
		private static var __clipParent:Sprite;
