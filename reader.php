    ...
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
         <style type="text/css">
            ...
            p{
                font-size: <?php echo $mash->telepromptfontsize;?>px;
            }
            #fim{
                color:white;
                text-align: center;
    ...
    <body bgcolor="#CCCCCC">
      ...
      <div id="menu">
        ...
        <script type="text/javascript">
            var velocidade = <?php echo $mash->telepromptspeed;?>;
            var pause = true;
...
function saveParameter(name, value){	
	...
	dummyimage.src = 'saveParameter.php?id=<?php echo $mash->id;?>&name='+ name +'&value='+ value;
	//alert('saveParameter.php?id=<?php echo $mash->id;?>&name='+ name +'&value='+ value);
	return true;
}
