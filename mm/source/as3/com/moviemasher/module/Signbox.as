...
package com.moviemasher.module
{
	...
	import flash.events.*;
/**
* Implementation class for Signbox composite effect module
*
* @see IModule
* @see Clip
* @see Mash
*/
	public class Signbox extends Picturebox
	{
		...
		override protected function _setCompositedSize():void
		{
			...
			try
			{
				if (__composited != null)
				{
					...
					var can_be_clicked:Boolean = Boolean(_getClipProperty('bsw').length);
