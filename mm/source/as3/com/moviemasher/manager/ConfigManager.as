...
*/
	public class ConfigManager extends Sprite implements IConfigManager
	{
		...
		public function source(urlOrID:String):ISource
		{
			...
			if (urlOrID.length)
			{
				...
				else
				{
					...
					{
						// it's a URI
						isource = new RunClass.RemoteSource() as ISource;
		...
		private var __optionTags = <moviemasher id="options"><option type='parse' evaluate_delimiter=',' /><option type='mash' quantize='10' imageseconds='5' themeseconds='5' effectseconds='5' /><option type='memory' maximum='104857600' /></moviemasher>; 
