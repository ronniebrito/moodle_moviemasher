...
*/
	public class MaskedSprite extends Sprite
	{
		...
		public function applyEffects(effects:Vector.<IClipEffect>, frame:Number):void
		{
			try
			{
		...
		public function applyTransition(transition_clip:IClipTransition, frame:Number):void
		{
			try
			{
				var clip_filters:Array;
				...
				transition_clip.setFrame(frame);
		...
		public function set metrics(iMetrics:Size):void
		{
			...
			{
				RunClass.MovieMasher['msg'](this + '.metrics ' + iMetrics, e);
			}
		}
