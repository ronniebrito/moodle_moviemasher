...
flashvarsObj.config = "media/xml/configEdit.php?params=<?php echo $_REQUEST['userid']; ?>__<?php echo $_REQUEST['cm_id']; ?>__<?php echo $_REQUEST['mash_id']; ?>";
...
function setMash(mash){
	...
	moviemasher().evaluate('player.volume=10');
