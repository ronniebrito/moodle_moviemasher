...
<!-- DEFAULT MASH  php gere e acordo com userid e cm_id-->

<?php ?>

  <mash width="320" height="240" crop="1" label="Example Mash" quantize="10"></mash>
...
<!-- PANEL INTERFACE LAYOUT -->
	...
	<panels>
		...
		<!-- STALL GRAPHIC PANEL -->
		<panel width='100' height='100' x='130' y='90'>
			<bar size='*'>
		...
		<panel curve='8' shadow='4' shadowcolor='9F9F9F' shadowblur='3' shadowstrength='1'  
			width='-380' height='264' x='360' y='20' 
		>
	...
	<control preselected="1" pattern='Video' bind="browser.parameters.group" value="video" select='browser.parameters.group=video' width='55' fill='stretch' forecolor='FFFFFF' textalign='center' symbol='../../moviemasher/com/moviemasher/control/Player/stable.swf@Text' icon='../../moviemasher/com/moviemasher/skin/Liquid/stable.swf@FadeOff' overicon='../../moviemasher/com/moviemasher/skin/Liquid/stable.swf@FadeOn' />
	<control pattern='Audio' select='browser.parameters.group=audio' bind='browser.parameters.group' value='audio' width='60' fill='stretch' forecolor='FFFFFF' textalign='center' symbol='../../moviemasher/com/moviemasher/control/Player/stable.swf@Text' icon='../../moviemasher/com/moviemasher/skin/Liquid/stable.swf@FadeOff' overicon='../../moviemasher/com/moviemasher/skin/Liquid/stable.swf@FadeOn' />
	<control pattern='Images' select='browser.parameters.group=image' bind='browser.parameters.group' value='image' width='65' fill='stretch' forecolor='FFFFFF' textalign='center' symbol='../../moviemasher/com/moviemasher/control/Player/stable.swf@Text' icon='../../moviemasher/com/moviemasher/skin/Liquid/stable.swf@FadeOff' overicon='../../moviemasher/com/moviemasher/skin/Liquid/stable.swf@FadeOn' />
			...
			<bar size='*' color='CACACA' grad='40' angle='270' align='right'>
				...
				>
					...
					<preview type="effect" preview='../../example/media/image/Logo/preview.jpg' icon="../../moviemasher/com/moviemasher/skin/Liquid/stable.swf@EffectPreview" />
			...
			<!-- SEARCH BAR -->
			<bar color='333333' grad='40' size='26' align='bottom' padding='4' spacing='0'  >
	...
	<control height='18' hide='browser.parameters.terms!=empty' icon='../../moviemasher/com/moviemasher/skin/Liquid/stable.swf#SearchRight' symbol='../../moviemasher/com/moviemasher/control/Player/stable.swf@Icon' />
		...
		<!-- TIMELINE PANEL --> 
 		<panel 
			...
			curve='8' shadow='4' shadowcolor='9F9F9F' shadowblur='3' shadowstrength='1'  
			width='-380' height='-324' x='20' y='304' 
		>
			...
			<!-- BUTTON BAR -->
			<bar color='333333' grad='40' size='26' spacing='6' padding='4'>
	...
	/>		
		...
		<!-- ZOOM SLIDER -->
				...
				<control tooltip='View Scale' bind='timeline.zoom' width='140' symbol='../../moviemasher/com/moviemasher/control/Player/stable.swf@Slider' min='1' max='100' icon='../../moviemasher/com/moviemasher/skin/Liquid/stable.swf#SliderHorzBtnOff' overicon='../../moviemasher/com/moviemasher/skin/Liquid/stable.swf#SliderHorzBtnOn' back='../../moviemasher/com/moviemasher/skin/Liquid/stable.swf@SliderHorzBackOff' reveal='../../moviemasher/com/moviemasher/skin/Liquid/stable.swf@SliderHorzBackOn' />
		...
		<panel 
			color='CACACA' grad='40' angle='270' 
			curve='8' shadow='4' shadowcolor='9F9F9F' shadowblur='3' shadowstrength='1'  
			width='320' height='-324' x='-340' y='304'
		>
			<!-- TITLE BAR -->
			<bar color='333333' grad='40' padding='0' align='top' spacing='1' size='26'>
				<control pattern="Editing: {label}" tie="timeline.selection.label" hide="timeline.selection.label=null" width='*' symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" forecolor='FFFFFF' textalign="center" textsize="11" wrap="0" />
				<control hide="timeline.selection.label!=null" width='*' symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" forecolor='FFFFFF' textalign="center" textsize="11" pattern="Select a clip to edit its properties here" />
			</bar>

			<!-- LABEL FIELD -->			
			<bar size="24" spacing="5" padding="2">
				<control width="45" hide="timeline.selection.label=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" pattern="Label" />
			...
			<!-- TRIMMER -->
			<bar size="24" spacing="5" padding="2">
				<control hide="timeline.selection.trim=null" tie="timeline.selection.trimstart,timeline.selection.trimend" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" pattern="Trim" />
			</bar>
			...
			<!-- LENGTH SLIDER -->
			<bar size="24" spacing="5" padding="2">
				<control tie="timeline.selection.lengthseconds" hide="timeline.selection.lengthseconds=null|timeline.selection.track&lt;0" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" pattern="Length: {lengthseconds} seconds" />
			</bar>
			<bar size="20" spacing="5" padding="2">
			...
			<!-- SPEED SLIDER -->
			<bar size="24" spacing="5" padding="2">
				<control tie="timeline.selection.speed" hide="timeline.selection.speed=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" pattern="Speed: {speed}" />
			</bar>
			<bar size="20" spacing="5" padding="2">
			...
			<!-- INSTANCES SLIDER -->
			<bar size="24" spacing="5" padding="2">
				<control tie="timeline.selection.instances" hide="timeline.selection.instances=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" pattern="Instances: {instances}" />
			</bar>
			<bar size="20" spacing="5" padding="2">
			...
			<!-- BRIGHTNESS SLIDER -->
			<bar size="24" spacing="5" padding="2">
				<control hide="timeline.selection.brightness=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" text="Brightness" />
			</bar>
			<bar size="20" spacing="5" padding="2">
			...
			<!-- CONTRAST SLIDER -->
			<bar size="24" spacing="5" padding="2">
				<control hide="timeline.selection.contrast=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" text="Contrast" />
			</bar>
			<bar size="20" spacing="5" padding="2">
			...
			<!-- HUE SLIDER -->
			<bar size="24" spacing="5" padding="2">
				<control hide="timeline.selection.hue=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" text="Hue" />
			</bar>
			<bar size="20" spacing="5" padding="2">
			...
			<!-- SATURATION SLIDER -->
			<bar size="24" spacing="5" padding="2">
				<control hide="timeline.selection.saturation=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" text="Saturation" />
			</bar>
			<bar size="20" spacing="5" padding="2">
			...
			<bar size="24" spacing="5" padding="2">
				<control width="*" hide="timeline.selection.forecolor=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" text="Color" />
				...
				<control width="*" hide="timeline.selection.backcolor=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" text="Back Color" />
			...
			<bar size="24" spacing="5" padding="2">
				<control hide="timeline.selection.font=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" text="Font" />
				<control hide="timeline.selection.textsize=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" text="Size" />
			</bar>
			
			<bar size="24" spacing="5" padding="2">
				
				<control hide="timeline.selection.font=null" bind="timeline.selection.font" width="*" symbol="../../moviemasher/com/moviemasher/control/Component/stable.swf@MMComboBox">
                
                	<option type="font" id="default" url="../../moviemasher/com/moviemasher/font/FreeSans/stable.swf@FreeSans" label="Free Sans" />
	<option type="font" id="BlackChancery" url="../../moviemasher/com/moviemasher/font/BlackChancery/stable.swf@BlackChancery" label="BlackChancery" />
	<option type="font" id="BuilderMarker" url="../../moviemasher/com/moviemasher/font/BuilderMarker/stable.swf@BuilderMarker" label="BuilderMarker" />
	<option type="font" id="FacetFolly" url="../../moviemasher/com/moviemasher/font/FacetFolly/stable.swf@FacetFolly" label="FacetFolly" />
	<option type="font" id="FutureDeco" url="../../moviemasher/com/moviemasher/font/FutureDeco/stable.swf@FutureDeco" label="FutureDeco" />
	<option type="font" id="GentesqueExtraBold" url="../../moviemasher/com/moviemasher/font/GentesqueExtraBold/stable.swf@GentesqueExtraBold" label="GentesqueExtraBold" />
	<option type="font" id="IdeomaSpray" url="../../moviemasher/com/moviemasher/font/IdeomaSpray/stable.swf@IdeomaSpray" label="IdeomaSpray" />
	<option type="font" id="JuraDemiBold" url="../../moviemasher/com/moviemasher/font/JuraDemiBold/stable.swf@JuraDemiBold" label="JuraDemiBold" />
	<option type="font" id="Pecita" url="../../moviemasher/com/moviemasher/font/Pecita/stable.swf@Pecita" label="Pecita" />
	<option type="font" id="PixAntiqua" url="../../moviemasher/com/moviemasher/font/PixAntiqua/stable.swf@PixAntiqua" label="PixAntiqua" />
	<option type="font" id="Sketchy" url="../../moviemasher/com/moviemasher/font/Sketchy/stable.swf@Sketchy" label="Sketchy" />
	<option type="font" id="Valken" url="../../moviemasher/com/moviemasher/font/Valken/stable.swf@Valken" label="Valken" />
			...
			<bar size="24" spacing="5" padding="2">
				<control hide="timeline.selection.orientation=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" text="Orientation" />
			</bar>
			<bar size="24" spacing="5" padding="2">
			...
			<!--FILL COMBOBOX -->
			<bar size="24" spacing="5" padding="2">
				<control hide="timeline.selection.fill=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" text="Resizing" />
			</bar>
			<bar size="24" spacing="5" padding="2">
				...
				<control hide="timeline.selection.fill=null" bind="timeline.selection.fill" width="*" symbol="../../moviemasher/com/moviemasher/control/Component/stable.swf@MMComboBox">
					<fill id="stretch" label="Stretch to Fill" />
					<fill id="crop" label="Scale with Crop" />
					<fill id="scale" label="Scale without Crop" />
				</control>
			</bar>
			...
			<!-- LONGTEXT FIELD -->			
			<bar size="24" spacing="5" padding="2">
				<control hide="timeline.selection.longtext=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" pattern="Text" />
			</bar>
			...
			<!-- BLEND MENU -->			
			<bar size="24" spacing="5" padding="2">
				<control hide="timeline.selection.blend=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" pattern="Blend" />
			</bar>
			<bar size="24" spacing="5" padding="2">
			...
			<!-- LOOPS SLIDER -->
			<bar size="24" spacing="5" padding="2">
				<control tie="timeline.selection.loops" hide="timeline.selection.loops=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" pattern="Loops: {loops}" />
			</bar>
			<bar size="20" spacing="5" padding="2">
			...
			<!-- ROTATE SLIDER -->
			<bar size="24" spacing="5" padding="2">
				<control hide="timeline.selection.rotate=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" text="Rotation" />
			</bar>
			<bar size="20" spacing="5" padding="2">
			...
			<bar size="24" spacing="5" padding="2">
				<control width="*" hide="timeline.selection.position=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" text="Position" />
				<control width="*" hide="timeline.selection.scale=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" text="Scale" />
			...
			<!-- ROTATE FADE SLIDER -->
			<bar size="24" spacing="5" padding="2">
				<control hide="timeline.selection.rotatefade=null" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" text="Fade Rotation" />
			</bar>
			<bar size="20" spacing="5" padding="2">
			...
			<bar size="24" spacing="5" padding="2">
				...
				<control width='*' hide="timeline.selection.effects=null" tie="timeline.selection.kind" symbol="../../moviemasher/com/moviemasher/control/Player/stable.swf@Text" textsize="11" pattern="{kind} Effects" />
			</bar>
			<bar size="*" padding="2" align='right'>
				...
				>
					<drop type='effect' />
					<preview type="effect" preview='../../example/media/image/Logo/preview.jpg' 
...
<!-- DYNAMIC MEDIA SOURCES -->
	...
	<source id='media' url='media/php/media.php?group={group}&amp;label={terms}&amp;index={index}&amp;count={count}' symbol='../../moviemasher/com/moviemasher/source/RemoteSource/stable.swf@RemoteSource' />
...
<!-- HANDLERS FOR ALL MEDIA EXCEPT IMAGES -->
	...
	<!-- HANDLERS FOR ALL MEDIA EXCEPT IMAGES -->
	<handler id='*' url='../../moviemasher/com/moviemasher/handler/FLVHandler/stable.swf@FLVHandler' />
	<handler id='mp3' url='../../moviemasher/com/moviemasher/handler/MP3Handler/stable.swf@MP3Handler' />
