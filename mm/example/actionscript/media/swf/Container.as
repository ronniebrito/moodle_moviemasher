package 
{
	...
	public class Container extends MovieClip
	{
		public function Container()
		{
			...
			var request:URLRequest = new URLRequest('../../moviemasher/com/moviemasher/core/MovieMasher/stable.swf');
		...
		var configuration:XML = <moviemasher>
			...
			<panel z='1' width='58' height='{layout.barsize}' x='{moviemasher.width}-({layout.padding}+{layout.spacing}+{layout.panelwidth}+58)' y='2*{layout.barsize}+{layout.padding}+{video.height}+{layout.spacing}'>
				<bar style='bar' color=''>
